...
<p>The	following	text	is	the	property	of	Wizards	of	the	
    Coast,	Inc.	and	is	Copyright	2000	Wizards	of	the	
    Coast,	Inc	("Wizards").	All	Rights	Reserved.	
</p>

<p>
    <strong>1.	Definitions:</strong>	(a)"Contributors"	means	the	
...
<p>
    <strong>2.	The	License:</strong>	This	License	applies	to	any	Open	
...
<p>
    <strong>3.Offer	and	Acceptance:</strong>	By	Using	the	Open	Game	
    Content	You	indicate	Your	acceptance	of	the	terms	of	
    this	License.	
</p>

<p>
    <strong>4.	Grant	and	Consideration:</strong>	In	consideration	for	
...
<p>
    <strong>5.Representation	of	Authority	to	Contribute:</strong>	If	You	
...
<p>
    <strong>6.Notice	of	License	Copyright:</strong>	You	must	update	the	
...
<p>
    <strong>7.	Use	of	Product	Identity:</strong>	You	agree	not	to	Use	any	
...
<p>
    <strong>8.	Identification:</strong>	If	you	distribute	Open	Game	
...
<p>
    <strong>9.	Updating	the	License:</strong>	Wizards	or	its	designated	
...
<p>
    <strong>10.	Copy	of	this	License:</strong>	You	MUST	include	a	copy	of	
    this	License	with	every	copy	of	the	Open	Game	
    Content	You	Distribute.	
</p>

<p>
    <strong>11.	Use	of	Contributor	Credits:</strong>	You	may	not	market	
...
<p>
    <strong>12.	Inability	to	Comply:</strong>	If	it	is	impossible	for	You	to	
...
<p>
    <strong>13.	Termination:</strong>	This	License	will	terminate	
...
<p>
    <strong>14.	Reformation:</strong>	If	any	provision	of	this	License	is	
...
<p>
    <strong>15.	COPYRIGHT	NOTICE</strong>	<br>
    <strong>Open	Game	License	v	1.0a</strong>	Copyright	2000,	Wizards	
    of	the	Coast,	LLC.	
</p>
